describe("The mostProfitableDepartment Function", function () {
  it("should check which department is the most profitable", function () {
    var salesData = [
  ...
  it("should check which department is the most profitable", function () {
    ...
    assert.equal(expected, mostProfitableDepartment(salesData2));
  });
  ...
  it("should check which department is the most profitable", function () {
    var salesData3 = [
      ...
      { department: "outdoor", sales: 1500, day: "Monday" },
      { department: "carpentry", sales: 5500, day: "Monday" },
      { department: "steelwork", sales: 12500, day: "Tuesday" },
      { department: "outdoor", sales: 2505, day: "Tuesday" },
      { department: "carpentry", sales: 1540, day: "Tuesday" },
      { department: "hardware", sales: 1500, day: "Wednesday" },
      { department: "outdoor", sales: 8507, day: "Wednesday" },
      ...
      { department: "electronics", sales: 12006, day: "Friday" },
      { department: "electronics", sales: 16109, day: "Saturday" },
      { department: "steelwork", sales: 17500, day: "Tuesday" },
      { department: "outdoor", sales: 2505, day: "Tuesday" },
      { department: "carpentry", sales: 1540, day: "Tuesday" },
      { department: "steelwork", sales: 11500, day: "Wednesday" },
      { department: "carpentry", sales: 8009, day: "Wednesday" },
    ];
    var expected = "steelwork";
    assert.equal(expected, mostProfitableDepartment(salesData3));
  });
});
